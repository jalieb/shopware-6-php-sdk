 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CartPrice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Cart_price';
...
'tax_status' => 'getTaxStatus'    ];
     ...
     * Sets net_price
     *
     * @param float $net_price Net price of the cart
     *
     * @return $this
     */
     ...
     * Sets total_price
     *
     * @param float $total_price Total price of the cart, including shipping costs, discounts and taxes
     *
     * @return $this
     */
     ...
     * Sets position_price
     *
     * @param float $position_price Price for all line items in the cart
     *
     * @return $this
     */
     ...
     * Sets tax_status
     *
     * @param string $tax_status Tax calculation for the cart. One of `gross`, `net` or `tax-free`
     *
     * @return $this
     */
