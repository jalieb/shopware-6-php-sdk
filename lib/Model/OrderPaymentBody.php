...
/**
 * OrderPaymentBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderPaymentBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'order_payment_body';
...
'order_id' => 'getOrderId'    ];
     ...
     *
     * @param string $payment_method_id The identifier of the paymentMethod to be set
     *
     * @return $this
     */
